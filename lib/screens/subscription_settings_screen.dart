...
class SubscriptionSettingsScreen extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    // Static pricing for PWA (actual price shown on Stripe Checkout)
    const premiumPrice = "\$35.99";
                  ...
                  child: SingleChildScrollView(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        _buildBenefitsList(l10n, isPremium, premiumPrice),
                        const SizedBox(height: AppSpacing.xxl),
  ...
  Widget _buildBenefitsList(AppLocalizations l10n, bool isPremium, String premiumPrice) {
    final benefits = [
      ...
      },
      {
        ...
        'subtitle': l10n.subscriptionBenefit150MessagesDesc(premiumPrice),
      },
      {
  ...
  Future<void> _openManageSubscription(BuildContext context, AppLocalizations l10n) async {
    ...
    if (customerPortalUrl.isEmpty) {
      ...
      if (context.mounted) {
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(
            content: Text(l10n.subscriptionManageViaEmail),
    ...
    final Uri url = Uri.parse(customerPortalUrl);
